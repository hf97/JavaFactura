...
{    
    ...
    private void entrarUtilizador (Informacao i) throws Exception{               
        ...
        else if(a.getClass().getSimpleName().equals("Empresa")){
    ...
    private void opcoesIndividual (Individual ui, Informacao i) throws Exception{
        ...
        switch(x){
            case(1):
                for(Despesa d : i.verificarDespesas(ui)){
    ...
    private void opcoesEmpresa (Empresa ue, Informacao i) throws Exception{
        ...
        switch(x){
            case(1):
                ...
                break;
            case(2):
                for(Despesa d : i.listaDespesaOrdenadaData(ue)){
                    System.out.println(d.toString());
                }
                System.out.println("\n\n0 - Voltar");
                x = input.nextInt();
                ...
                break;
            case(3):
                for(Despesa des : i.listaDespesaOrdenadaValor(ue)){
            ...
            case(4):
                ...
                for(Despesa desp : i.listaDespesaContribuinteEntreData(ue, clienteNIF)){
            ...
            case(5):
                ...
                for(Despesa despe : i.listaDespesaContribuinteOrdenadaDecrescenteDespesa(ue, cliNIF)){
     ...
     * 
     * @param  u    Estado atual da Informacao
     */
    ...
    private void menuOpcoesAdministrador(Informacao i) throws Exception{
        ...
        switch(x){
            case(1):
                for(Actor a : i.relacaoDezContribuintesMaisGastadores()){
            ...
            case(2):
                ...
                int a = input.nextInt();
                for(Actor acto : i.XEmpresasMaisFaturas(a)){
                ...
                break;
            case(3):
                for(Actor ac : i.imprimeIndividual()){
                ...
                break;
            case(4):
                for(Actor act : i.imprimeEmpresa()){
                ...
                break;
            case(5):
                for(Despesa d : i.imprimeDespesa()){
                    System.out.println(d.toString());
                }
                System.out.println("\n\n0 - Voltar");
                x = input.nextInt();
                ...
                break;
            case(6):
                for(FaturaAtividadeCorrigida fac : i.listaFaturaAtividadeCorrigida()){
        ...
        if(x>0 && x<=2){
            ...
            switch(x){
                case(1):
                    ...
                    Set<CodigoAtividadeEconomica> atividadeEconomica = new HashSet<CodigoAtividadeEconomica>(numeroAtividadeEconomica);
                ...
                case(2):
                    ...
                    System.out.println("Atividade economica: ");
                    Menu.menuCodigoAtividadeEconomica();
                    Set<CodigoAtividadeEconomica> atiEco = new HashSet<CodigoAtividadeEconomica>(numAtiEco);
