public class Menu
{
    public static void menuPrincipal(){
        System.out.println("1 - Entrar utilizador\n"+
    ...
    public static void menuOpcoesIndividual(){
        System.out.println("1 - Verificar despesas\n"+
    ...
    public static void menuOpcoesAdministrador(){
        System.out.println("1 - Relacao dos 10 contribuintes que mais gastam no sistema\n"+
    ...
    public static void menuRegistarUtilizador(){
        System.out.println("1 - Contribuinte indivual\n"+
                           "2 - Empresa\n"+
                           "\n0 - Voltar");
    }
    public static void menuCodigoAtividadeEconomica(){
        System.out.println("1 - Construcao\n" +
                           "2 - Transporte\n" +
                           "3 - Alimento\n" +
                           "4 - Saude\n" +
                           "5 - Educacao\n" +
