 ...
 */
public class Individual extends Utilizador implements Serializable
{
     ...
     */
    public Individual (int NIF, String email, String nome, String morada, int password, double valorGasto, int numeroAgregadoFamiliar, int numeroFilhos, ArrayList<Integer> NIFAgregadoFamiliar, double coeficienteFiscal, Set<AtividadeEconomica> atividadeEconomica){
    ...
    public Individual (Individual i){
        ...
        this.atividadeEconomica = i.getAtividadeEconomica();
    }
     ...
     *
     * @param   numeroAgregadoFamiliar   numero de dependentes do agregado familiar
     */
     ...
     *
     * @param   numeroFilhos   numero de filhos num agregado familiar
     */
     ...
     *
     * @param   atividadeEconomica   codigo da atividade economica
     */
